...
pub fn update_and_swap_ai_dex<'info>(
    ai_dex: &mut Account<'info, AiDexPool>,
...
pub fn update_and_two_hop_swap_ai_dex<'info>(
    ...
    // ai_dex
    ai_dex_one: &mut Account<'info, AiDexPool>,
    ai_dex_two: &mut Account<'info, AiDexPool>,
    // direction
