...
pub struct TradeBatchPositionOpenedEvent {
    ...
    pub position_trade_batch: PositionTradeBatchData,
    pub trade_batch_position: TradeBatchPositionData,
    pub position_trade_batch_authority: Pubkey,
    pub position_trade_batch_token_account: PositionTradeBatchTokenAccountData,
    pub ai_dex: Pubkey,
    pub funder: Pubkey,
}

#[derive(AnchorSerialize, AnchorDeserialize, Clone)]
pub struct PositionTradeBatchData {
    pub key: Pubkey,
    pub position_trade_batch_mint: Pubkey,
}

#[derive(AnchorSerialize, AnchorDeserialize, Clone)]
pub struct TradeBatchPositionData {
    pub tick_lower_index: i32,
    pub tick_upper_index: i32,
}

#[derive(AnchorSerialize, AnchorDeserialize, Clone)]
pub struct PositionTradeBatchTokenAccountData {
    pub key: Pubkey,
    pub mint: Pubkey,
    pub amount: u64,
}
...
pub fn open_trade_batch_position_handler(
    ...
    emit!(TradeBatchPositionOpenedEvent {
        trade_batch_index,
        position_trade_batch: PositionTradeBatchData {
            key: position_trade_batch.key(),
            position_trade_batch_mint: position_trade_batch.position_trade_batch_mint,
        },
        trade_batch_position: TradeBatchPositionData {
            tick_lower_index,
            tick_upper_index,
        },
        position_trade_batch_authority: ctx.accounts.position_trade_batch_authority.key(),
        position_trade_batch_token_account: PositionTradeBatchTokenAccountData {
            key: ctx.accounts.position_trade_batch_token_account.key(),
            mint: ctx.accounts.position_trade_batch_token_account.mint,
            amount: ctx.accounts.position_trade_batch_token_account.amount,
        },
        ai_dex: ai_dex.key(),
